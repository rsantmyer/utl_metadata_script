...
PROMPT Generating one script for OBJECT_TYPE = TABLE and OBJECT_NAME = EMPLOYEES...
...
COLUMN filter_column_01_value FORMAT A16
COLUMN filter_column_02_value FORMAT A24
